...
{
    internal class QuizDetailsDtoAggregation : AggregationBase<QuizDetailDto>
    {
        private readonly IMongoCollection<QuizAggregate> _mongoCollection;

        public QuizDetailsDtoAggregation(MongoClient mongoClient, IMongoRepositorySettings mongoRepositorySettings)
        {
        ...
        protected override IAggregateFluent<QuizDetailDto> GetAggregations()
        {
